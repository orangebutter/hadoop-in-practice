...
public class IPSeeker {
    public static String qqwryFileURL = "";
    /** *//**
    ...
    //    private static final File IP_FILE = new File(IPSeeker.class.getResource("c:\\qqwry.dat").toString());
    private File IP_FILE;
  ...
  //  private static IPSeeker instance = new IPSeeker();
     ...
     * 私有构造函数
     */
    public IPSeeker(String qqwryFileURL)  {
...
//       System.out.println(" area " + IPSeeker.getInstance().getArea("111.13.8.250"));
//        System.out.println(" address " + IPSeeker.getInstance().getAddress("111.13.8.250"));
